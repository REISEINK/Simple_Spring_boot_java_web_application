...
function _setCopy(text, msg){
	if(BROWSER.ie) {
		...
		if(r) {
			...
			showDialog('<div class="c"><div style="width: 200px; text-align: center;">����ʧ�ܣ���ѡ���������ʡ�</div></div>', 'alert');
		}
	} else {
...
function _zoom(obj, zimg, nocover, pn, showexif) {
	...
	if(!menu && !pn) {
		...
		menu.id = menuid;
		if(cover) {
			menu.innerHTML = '<div class="zoominner" id="' + menuid + '_zoomlayer" style="display:none"><p><span class="y"><a id="' + menuid + '_imglink" class="imglink" target="_blank" title="���´��ڴ�">���´��ڴ�</a><a id="' + menuid + '_adjust" href="javascipt:;" class="imgadjust" title="ʵ�ʴ�С">ʵ�ʴ�С</a>' +
				'<a href="javascript:;" onclick="hideMenu()" class="imgclose" title="�ر�">�ر�</a></span>����������ͼƬ</p>' +
				'<div class="zimg_p" id="' + menuid + '_picpage"></div><div class="hm" id="' + menuid + '_img"></div></div>';
		} else {
			menu.innerHTML = '<div class="popupmenu_popup" id="' + menuid + '_zoomlayer" style="width:auto"><span class="right y"><a href="javascript:;" onclick="hideMenu()" class="flbc" style="width:20px;margin:0 0 2px 0">�ر�</a></span>����������ͼƬ<div class="zimg_p" id="' + menuid + '_picpage"></div><div class="hm" id="' + menuid + '_img"></div></div>';
		}
